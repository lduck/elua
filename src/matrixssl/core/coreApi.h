...
//pre cele casovacie funkcie skus skotrolovat http://www.eluaproject.net/doc/master/en_arch_platform_timers.html
PSPUBLIC int32		psGetTime(psTime_t *t); //toto by malo byt cmn_systimer_get()
