 ...
 */
#define	SSL_DEFAULT_IN_BUF_SIZE		1024//512//1024		/* Baseline recv buf size */
#define	SSL_DEFAULT_OUT_BUF_SIZE	1024//1024		/* Baseline send buf size */
...
*/
#define SSL_SESSION_TABLE_SIZE	1
