...
#define CRYPTO_FLAGS_INBOUND	0x200
#define CRYPTO_FLAGS_ARC4INIT	0x400
#define CRYPTO_FLAGS_BLOCKING	0x800

#define CRYPTO_FLAGS_DISABLED	0x1000
...
#define psPadDownLenPwr2(LEN, BLOCKSIZE) \
    BLOCKSIZE <= 1 ? (unsigned char)0 : \
    (unsigned char)( (LEN) & (BLOCKSIZE - 1) )
